...
void loop()
{
    ...
    if (Firebase.ready() && (millis() - dataMillis > 60000 || dataMillis == 0))
    {
        ...
        // timestamp
        content.set("fields/time/timestampValue", "2014-10-02T15:01:23Z"); // RFC3339 UTC "Zulu" format
        ...
        content.set("fields/lat/stringValue", "23.678198");
        content.set("fields/lon/stringValue", "23.678198");
